...
# Quando o MPU classifica o robo como SUBINDO, o segue-linha usa PWM 120; em
...
GREEN_TURN_BLIND_TIME = .30                # s — nao prolonga pivot se o ramo sumir
...
GREEN_TURN_TIMEOUT = 2.0                   # s — para antes de ultrapassar o ramo perdido
...
# ---------------------------------------------------------------------------
# Entrada por corredor branco entre laterais pretas
# ---------------------------------------------------------------------------
# Depois de ter seguido uma linha, exige preto nas duas laterais, centro branco
# e nenhuma continuacao central. Para imediatamente e entra apenas se essa
# geometria permanecer por todo o intervalo. Boot, curva, marcador e gap nao
# contam o temporizador.
ENTRY_NO_BLACK_RESCUE_TEST_ENABLED = True
ENTRY_NO_BLACK_RESCUE_DELAY_S = 3.0
# Geometria da entrada por branco: preto dos dois lados, corredor central sem
# preto e nenhuma continuacao da linha a frente. Razoes sobre a mascara preta.
ENTRY_WHITE_GATE_Y_MIN = .42
ENTRY_WHITE_GATE_Y_MAX = .94
ENTRY_WHITE_GATE_LEFT_X_MIN = .02
ENTRY_WHITE_GATE_LEFT_X_MAX = .32
ENTRY_WHITE_GATE_CENTER_X_MIN = .38
ENTRY_WHITE_GATE_CENTER_X_MAX = .62
ENTRY_WHITE_GATE_RIGHT_X_MIN = .68
ENTRY_WHITE_GATE_RIGHT_X_MAX = .98
ENTRY_WHITE_GATE_SIDE_MIN_BLACK_RATIO = .28
ENTRY_WHITE_GATE_CENTER_MAX_BLACK_RATIO = .10
