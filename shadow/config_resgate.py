...
BALL_PICKUP_INITIAL_LEFT_DELTA = -20
BALL_PICKUP_INITIAL_RIGHT_DELTA = 20
...
# Segunda leitura usada SOMENTE depois do LOCK. Como a posição anterior é
# conhecida, podemos aceitar preto mais claro e incompleto sem tornar a busca
# inicial permissiva.
EXIT_BLACK_LOCK_HSV_MAX = (180, 255, 115)
EXIT_BLACK_LOCK_MIN_ROW_FILL = 0.18
EXIT_BLACK_LOCK_MIN_SPAN_RATIO = 0.18
EXIT_BLACK_LOCK_MIN_THICKNESS_RATIO = 0.01
EXIT_BLACK_LOCK_MAX_THICKNESS_RATIO = 0.38
EXIT_BLACK_LOCK_MIN_FILL_RATIO = 0.32
EXIT_BLACK_LOCK_MIN_ASPECT = 1.8
EXIT_BLACK_LOCK_MAX_INSIDE_VALUE = 125.0
EXIT_BLACK_LOCK_MIN_SURROUND_CONTRAST = 9.0
EXIT_BLACK_LOCK_MIN_CONFIDENCE = 0.22
