"""Calcula a geometria do fim da linha durante a validação de gap."""

import cv2
import numpy as np

from config import camera_x, camera_y
from shared.dados_compartilhados import gap_angle, gap_center_x, gap_center_y, gap_end_width
...
def apply_gap_avoid_mask(black_image):
    """Apaga as laterais durante a travessia do gap."""
