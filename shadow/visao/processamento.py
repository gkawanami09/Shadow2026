...
def vision_loop(debug=False, record_dir=None):
    # ``record_dir`` permanece na assinatura para compatibilidade com main.py.
    # Esta versao deliberadamente simples nao grava a topologia removida.
    del record_dir
    ...
    try:
        while not terminate.value:
            ...
            # O detector continua sendo o original (verde antes do preto),
            # mas uma leitura isolada nao pode iniciar uma manobra.
            turn_direction = confirmador_verde.atualizar(turn_direction)
            ...
            publicar_resultado_visao_rapida(
                ...
                ponto_futuro_x=ponto_alvo_x_frame,
                ponto_futuro_y=ponto_alvo_y_frame,
