...
8. **Fase 7 - Segue-linha limpo:** usar `follow_clean.py` com centroline conectada, lookahead e `LADO` assinado; recuperar somente quando a linha ou o guia estiver invalido.
