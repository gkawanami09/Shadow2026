...
CONFIANCA_MIN_VERDE_DESALINHADO = 0.65
...
def inferir_lado_verde_desalinhado(candidato, cruzamento, resultado_linha=None):
    ...
    if referencia is None:
        referencia = candidato.get("largura_frame", 0) / 2
