...
from config import (
    CAMERA_HEIGHT, CAMERA_WIDTH, PASTA_CAPTURAS,
    VERDE_H_MIN, VERDE_H_MAX, VERDE_S_MIN, VERDE_V_MIN,
    VERDE_G_MENOS_R_MIN, VERDE_G_MENOS_B_MIN,
    KERNEL_VERDE, OPEN_VERDE, CLOSE_VERDE,
    VERDE_Y_MIN_REL, VERDE_Y_MAX_REL,
    VERDE_AREA_MIN_LONGE, VERDE_AREA_MIN_PERTO,
    VERDE_AREA_MAX_REL_QUADRO, VERDE_AREA_ABSURDA_REL_QUADRO,
    VERDE_ASPECTO_MIN, VERDE_ASPECTO_MAX,
    VERDE_FILL_RATIO_MIN, VERDE_PROPORCAO_MIN,
    VERDE_MARGEM_DEPOIS_MIN_PX, VERDE_MARGEM_DEPOIS_MAX_PX, VERDE_MARGEM_DEPOIS_MULT_ALTURA,
    VERDE_FRAC_MIN_BBOX_ANTES,
    MARGEM_SEPARAR_VERDE_INTERSECAO, MARGEM_VERDE_DESALINHADO_Y, MARGEM_VERDE_SOBREPOSTO_Y,
    CONFIANCA_MIN_VERDE_DESALINHADO, AREA_MIN_VERDE_DESALINHADO, AREA_MAX_VERDE_DESALINHADO,
    FATOR_AREA_MIN_VERDE_PARCIAL_DESALINHADO, AREA_MIN_VERDE_PARCIAL_ABS,
    CONFIANCA_MIN_VERDE_PARCIAL_DESALINHADO, FILL_RATIO_MIN_VERDE_PARCIAL,
    PRETO_MARGEM_VERDE_MULT, PRETO_MIN_PIXELS_ABS, PRETO_MIN_PIXELS_REL, PRETO_MIN_LADOS_AO_REDOR,
    MARGEM_CENTRO_LINHA_MULT, MARGEM_CENTRO_VERDE_INTERSECAO_MULT, MARGEM_CENTRO_VERDE_INTERSECAO_MAX,
    MARGEM_INFERIR_LADO_FORTE_PX, MARGEM_INFERIR_LADO_FORTE_MULT_LINHA,
    CONFIANCA_MIN_INFERIR_LADO_CENTRO, TEMPO_SEGURAR_VERDE_LADO_FORTE, CONFIANCA_MIN_SEGURAR_LADO_VERDE,
    BUSCA_LINHA_DY,
    AREA_MIN_VERDE_ABSOLUTA, LARGURA_MIN_VERDE, ALTURA_MIN_VERDE,
    MULT_LARGURA_CRUZAMENTO, LARGURA_LINHA_FALLBACK, INTERVALO_DEBUG_CAMERA,
)
